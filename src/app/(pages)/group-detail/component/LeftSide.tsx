...
import { Button, Col, Collapse, Nav, NavItem, NavLink, Offcanvas, OffcanvasBody, OffcanvasHeader } from "react-bootstrap";
    ...
    return (
        <>
            <div className="text-center d-grid position-fixed start-0 bottom-0 w-100" style={{ zIndex: "1030" }}>
                <button className="btn btn-primary rounded-0 py-2 d-xxl-none mb-0" onClick={() => setShow(true)}>
                    <FaSlidersH className="me-2" />My menu
                </button>
            </div>

            <Col xxl={2}>
                <Offcanvas show={show} onHide={() => setShow(false)} placement="end" className="p-3 p-xxl-0" responsive="xxl">
                    <OffcanvasHeader closeButton className="justify-content-end pt-0 pe-0" />
                    <OffcanvasBody className="p-0 d-block">
                        <Nav className="nav-link-sidebar flex-column gap-2">
                            <NavItem>
                                <Link className="nav-link d-flex align-items-center" href="/que-ans/index">
                            ...
                            <NavItem>
                                <Link className="nav-link d-flex align-items-center active" href="/group">
                                    <span className="nav-icon">
                                        <svg width="22" height="22" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
