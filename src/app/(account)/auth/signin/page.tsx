            ...
            <section className="py-0">
                <Container>
                    <Row className="justify-content-center text-center align-items-center vh-100 py-5">
                        ...
                        <Col sm={10} md={10} lg={7} xl={6} xxl={5}>

                            <div className="card card-body p-4 p-sm-5">


                                <h1 className="mb-2 h3">Welcome back</h1>
                                <p className="mb-0">New here?<Link href="/auth/signup"> Create an account</Link></p>
                                ...
                                <form className="mt-sm-4 text-start">
                                    ...
                                    <Row className="g-3">
                                        ...
                                        <Col sm={6} className="d-grid">
                                            <Link href="#" className="btn btn-outline-light mb-0"><FaFacebookF className="fab fa-fw text-facebook me-2"></FaFacebookF>Facebook</Link>
                                        </Col>
                                    </Row>
