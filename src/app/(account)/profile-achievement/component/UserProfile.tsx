            ...
            <Card className="p-0">
                ...
                <div className="card-footer border-top pb-0">
                    <ul className="nav nav-bottom-line nav-responsive align-items-center gap-2 mb-0 border-0">
                        ...
                        <li className="nav-item"> <Link className="nav-link" href="/profile-follower">2.5K Followers</Link> </li>
                        <li className="nav-item"> <Link className="nav-link active" href="/profile-achievement">Achievement</Link> </li>
                    </ul>
                </div>
            </Card>
