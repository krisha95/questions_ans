  ...
  return (
    <div className="card hstack gap-0 align-items-start p-0">
      ...
      <div className="user-vote w-70px p-3">
        <div
          className="btn-group vstack flex-wrap gap-1 align-items-center"
          role="group"
        >
          <input
            type="radio"
            ...
            id="btnradio9"
          />
          <label className="btn btn-vote mb-0" htmlFor="btnradio9">
            <BsFillHandThumbsUpFill />
          </label>
          ...
          <input
            ...
            id="btnradio10"
          />
          <label className="btn btn-vote mb-0" htmlFor="btnradio10">
            {" "}
            <BsFillHandThumbsDownFill />
          </label>
        </div>
      ...
      <div className="card-body p-sm-4">
          ...
          <Collapse in={open}>
            <div className="content-wrap mt-2" id="collapseContent3">
              <p className="mb-0">
                ...
                Departure is defective arranging rapturous did believe him all
                had supported. Family months lasted simply set nature vulgar
                him. Picture for attempt joy excited ten carried manners talking
              ...
              <p className="mb-0 mt-2">
                Resolving breakfast am or perfectly. It drew a hill from me.
        ...
        <div className="d-md-flex justify-content-md-between mt-4">
          <div className="d-flex align-items-center">
            ...
            <div className="ms-2">
              <h6 className="mb-0">
                <Link href="my-profile.html">Billy Vasquez</Link>
              </h6>
