...
import { BsCardList, BsReply, BsSearch } from 'react-icons/bs'
                ...
                <Container>
                    ...
                    <div className={`navbar-collapse collapse ${openMenu ? "show" : ""}`} id="navbarCollapse">
                        ...
                        <ul className="navbar-nav navbar-nav-scroll dropdown-hover ms-auto">
                            ...
                            <li className="nav-item"> <Link className="nav-link" href="/tickets/list"><BsCardList className="me-1" />Ticket list</Link> </li>

                            <li className="nav-item"> <Link className="nav-link" href="/tickets/reply"><BsReply className="fa-lg me-1" />Ticket reply</Link> </li>
                        </ul>
                    </div>
                    ...
                    <ul className="nav align-items-center ms-sm-2">
                        ...
                        <li className="nav-item dropdown nav-search ms-2">
                            <Link className="btn btn-light btn-round mb-0" role="button" href="#" id="navSearch" data-bs-toggle="dropdown" aria-expanded="true" data-bs-auto-close="outside" data-bs-display="static">
                                <BsSearch />
                            </Link>
                        ...
                        <li className="nav-item d-none d-md-block ms-2">
                            <Link href="/tickets/create" className="btn btn-sm btn-dark mb-0">Submit ticket</Link>
                        </li>
