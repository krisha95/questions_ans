...
import { BsCardList, BsGear, BsPerson, BsPower, BsReply } from 'react-icons/bs'
...
const NavBar2 = () => {
    ...
    return (
        <header className="header-sticky heade-absolute bg-mode">
                ...
                <div className="container">
                    ...
                    <div className={`navbar-collapse collapse ${openMenu ? "show" : ""}`} id="navbarCollapse">
                        ...
                        <div className="nav my-3 my-xl-0 px-4 flex-nowrap align-items-center">
                            <div className="nav-item w-100 input-bg-light">
                                <form className="position-relative">
                                    ...
                                    <button className="btn btn-link py-0 position-absolute top-50 end-0 translate-middle-y" type="submit"><FaSearch className="fas fs-6 heading-color" /></button>
                                </form>
                            </div>
                        </div>
                        ...
                        <ul className="navbar-nav navbar-nav-scroll dropdown-hover ms-auto">
                            ...
                            <li className="nav-item"> <Link className="nav-link active" href="/tickets/list"><BsCardList className="me-1" />Ticket list</Link> </li>
