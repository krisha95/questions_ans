...
import { Col, Form, Offcanvas, OffcanvasBody, OffcanvasHeader } from "react-bootstrap";
import {
    BsCalendarEvent,
    BsClockHistory,
    BsEye,
...
const Rightsidebar = ({ show, onHide }: RightSidebarProps) => {
    return (
        <Col xl={3} xxl={2}>
            <Offcanvas show={show} onHide={onHide} placement="end" responsive="xl">
