...
import { Button, Col, Collapse, Nav, NavLink } from "react-bootstrap";
...
const LeftSide = () => {
    ...
    return (
        <Col xxl={2}>
            <form className="input-borderless mb-4">
                <textarea className="form-control fs-6 border-0 rounded-bottom-0" id="textareaBox" rows={5} spellCheck="false" placeholder="Ask a Question..."></textarea>
            ...
            <nav className="navbar navbar-light navbar-expand-xxl mx-0">
                <div className="offcanvas offcanvas-end p-3 p-xxl-0" tabIndex={-1} id="offcanvasNavbar">
                    ...
                    <div className="offcanvas-body p-0 d-block">
                        ...
                        <ul className="nav nav-link-sidebar nav-sidebar-bg-light bg-mode rounded flex-column gap-2 p-2">


                            <li className="nav-item">
                                <Link className="nav-link d-flex align-items-center active" href="/index">
                            ...
                            <li className="nav-item">
                                <Link className="nav-link d-flex align-items-center" href="/index-forum">
                                    <span className="nav-icon">
                                        <svg width="22" height="22" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <li className="nav-item">
                                <Link className="nav-link d-flex align-items-center" href="/index-discussion">
                                    <span className="nav-icon">
                                        <svg width="22" height="22" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <li className="nav-item">
                                <Link className="nav-link d-flex align-items-center" href="/answer-detail-v2">
                                    <span className="nav-icon">
                            ...
                            <li className="nav-item">
                                <Link className="nav-link d-flex align-items-center" href="/group">
                                    <span className="nav-icon">
                                        <svg width="22" height="22" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <li className="nav-item">
                                <Link className="nav-link d-flex align-items-center" href="/my-profile">
                                    <span className="nav-icon">
                                        <svg width="22" height="22" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <li className="nav-item">
                                <Link className="nav-link d-flex align-items-center" href="/index-help-center">
                                    <span className="nav-icon">
                                        <svg width="22" height="22" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
