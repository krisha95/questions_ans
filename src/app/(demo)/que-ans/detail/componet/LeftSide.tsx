                    ...
                    <div className="offcanvas-body p-0 d-block">
                        ...
                        <ul className="nav nav-link-sidebar flex-column gap-2">
                            ...
                            <li className="nav-item">
                                <a className="nav-link d-flex align-items-center active" href="/que-ans/index">
                            ...
                            <li className="nav-item">
                                <a className="nav-link d-flex align-items-center" href="index-forum.html">
                                    <span className="nav-icon">
                                        <svg width="22" height="22" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <li className="nav-item">
                                <a className="nav-link d-flex align-items-center" href="answer-detail-v2.html">
                                    <span className="nav-icon">
                            ...
                            <li className="nav-item">
                                <a className="nav-link d-flex align-items-center" href="group.html">
                                    <span className="nav-icon">
                                        <svg width="22" height="22" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <li className="nav-item">
                                <a className="nav-link d-flex align-items-center" href="my-profile.html">
                                    <span className="nav-icon">
                                        <svg width="22" height="22" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <li className="nav-item">
                                <a className="nav-link d-flex align-items-center" href="index-help-center.html">
                                    <span className="nav-icon">
                                        <svg width="22" height="22" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
